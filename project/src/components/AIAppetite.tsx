...
export default function AIAppetite() {
  return (
    <section id="aiappetite" className="py-20 bg-black">
          ...
          <div className="bg-gray-900/80 rounded-2xl shadow-2xl p-8 md:p-12 border border-cyan-400/20">
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
              <div className="flex-shrink-0">
                <div className="w-24 h-24 bg-gradient-to-br from-cyan-500 to-pink-500 rounded-full flex items-center justify-center shadow-xl">
