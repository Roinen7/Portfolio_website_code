...
const awards = [
  {
    ...
    image: '/240612-BM-famelab-finale-87 copy.jpg',
  ...
  {
    title: 'Hinterland Hack - Schnelleker Logistics Challenge',
    ...
    image: '/Kopie von 20250921_Founders_Foundation_01562 copy.jpg',
