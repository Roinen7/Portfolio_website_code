...
const skillCategories = [
  {
    title: 'AI & Automation',
    icon: Brain,
    skills: ['Generative AI for Sales', 'AI Agents', 'No-Code AI Tools', 'Process Automation'],
    color: 'emerald',
  ...
  },
  {
    ...
    icon: Code,
    skills: ['Video Editing', 'Photo Editing', 'Sound Editing', 'Content Creation'],
    color: 'orange',
  ...
  },
  {
    title: 'Languages',
    icon: Globe,
    skills: ['English (Native)', 'Bengali (Native)', 'Hindi (Professional)', 'German (Limited)'],
    color: 'teal',
